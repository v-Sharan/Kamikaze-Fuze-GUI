  ...
  tour: {
    steps: [
      ...
      },
      {
        ...
        content: (
          <>
            <b>This is the map view of XAG GCS.</b>
            <p>
      ...
      },
      {
        ...
        content: (
          <>
            In fact, the entire user interface of XAG GCS is based on tabs that
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <p>
              This button lets you open a drone show in XAG GCS (
        ...
        content: (
          <>
            ...
            <p>
              ...
              detailed tutorial about setting up a drone show in XAG GCS.
            </p>
          </>
        ),
      },
